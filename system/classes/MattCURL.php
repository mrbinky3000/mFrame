...
class MattCURL
{
    ...
    {
        self::$s_user_agent = "DC Activity Bot ({$_SERVER['HTTP_HOST']})";
    ...
    public static function get_web_page($s_url, $a_args = array(), $b_post = TRUE, $s_credentials = '')
    {
        ...
        curl_setopt($o_ch, CURLOPT_CONNECTTIMEOUT, 30);
        curl_setopt($o_ch, CURLOPT_TIMEOUT, 30);    
        ...
        if (ini_get('open_basedir') == '' && ini_get('safe_mode' == 'Off'))
        {
            ...
            curl_setopt($o_ch, CURLOPT_MAXREDIRS, 10); // be safe: stop after 10 redirects
